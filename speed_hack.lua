...
if wxfks ~= 0 then
  ...
  senergy[2].address = wxf[1].address -52
  senergy[2].value = "-5" 
  senergy[2].freeze = true
  gg.addListItems(senergy)
  gg.clearResults()
  gg.clearList(senergy)
end
end
...
function magicmenu()
  gf = gg.choice({'Do spell','Do spell no effects','Modify spell','Random spells','Remove all'},nil,'')
      ...
      if m == 5 then
        ...
        if x == 8 then 
          if eoffsets.gframe == 0x00 then
            eoffsets.gframe = getadd(eoffsets.nentity + poffsets.ptofps,gg.TYPE_QWORD) + 0x2D8
          end
